...
cat $INJHOME/config/genesis.json | jq '.app_state["gov"]["params"]["voting_period"]="15s"' > $INJHOME/config/tmp_genesis.json && mv $INJHOME/config/tmp_genesis.json $INJHOME/config/genesis.json
cat $INJHOME/config/genesis.json | jq '.app_state["gov"]["params"]["expedited_voting_period"]="10s"' > $INJHOME/config/tmp_genesis.json && mv $INJHOME/config/tmp_genesis.json $INJHOME/config/genesis.json
...
cat $INJHOME/config/genesis.json | jq '.app_state["exchange"]["params"]["exchange_admins"]+=["inj158ucxjzr6ccrlpmz8z05wylu8tr5eueqang232"]' > $INJHOME/config/tmp_genesis.json && mv $INJHOME/config/tmp_genesis.json $INJHOME/config/genesis.json
...
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $WASM_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $VAL_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER1_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER2_KEY -a --home $INJHOME ) 10000000000000000000000000inj,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER3_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER4_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER5_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER6_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER7_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER8_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER9_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
yes $PASSPHRASE | injectived add-genesis-account --chain-id $CHAINID --home $INJHOME $(injectived keys show $USER10_KEY -a --home $INJHOME ) 10000000000000000000000000inj,1000000000000000000000atom,100000000000000000000000000peggy0xdAC17F958D2ee523a2206206994597C13D831ec7,100000000000000000000000000peggy0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599

echo "Signing genesis transaction"
# Sign genesis transaction
yes $PASSPHRASE | injectived genesis gentx $VAL_KEY 100000000000000000000000inj --chain-id $CHAINID --home $INJHOME
